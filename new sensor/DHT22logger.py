...
def main():
	...
	try:
		sensor1temperature, sensor1humidity = sensorReadings(gpioForSensor1,gpioForSensor2)
	...
	if sensorsToRead != "1":
		try:
			sensor2temperature, sensor2humidity = sensorReadings(gpioForSensor1,gpioForSensor2)
